...
open class WebServer {
    ...
    /**
     * Create the controller, passing it the [WebAccountsService] to use.
    ...
    companion object {
         ...
         * doesn't matter.
         */
        val ACCOUNTS_SERVICE_URL = "http://ACCOUNTS-SERVICE"
        ...
        @JvmStatic fun main(args: Array<String>) {
            ...
            SpringApplication.run(WebServer::class.java, *args)
        }
    }
}
